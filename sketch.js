...
function setup(){
  ...
  ground = createSprite(displayWidth/2,displayHeight/2+300,displayWidth,20);
  ground.velocityX = -10;
...
function spawnfood(){
  if(frameCount % 80 === 0){
    ...
    banana.debug = false;
    banana.velocityX = -4;
    banana.y = Math.round(random(displayHeight/2+100,300));
    banana.lifetime = 300;
...
function spawnObstacle(){
  if(frameCount % 300 === 0){
    stone = createSprite(650,700,0,0);
